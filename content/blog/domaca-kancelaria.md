...
{{ image(path="moonlander.jpg" alt="Moonlander") }}
...
{{ image(path="keybr10h.png" alt="Keybr") }}
{{ image(path="monkeytype.png" alt="monkeytype") }}
...
{{ image(path="moonlander2.jpg" alt="Moonlander2") }}
