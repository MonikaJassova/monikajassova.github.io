...
{{ image(path="etl.png" alt="ETL proces") }}
...
{{ image(path="airflow.png" alt="Workflow v Airflow") }}

Na samotné spracúvanie dát sme používali Apache Spark, o ktorom som písala [v tomto príspevku](@/blog/spark.md). Pre predstavu na akom HW Spark a Hadoop bežal, išlo o Oracle BDA/HDFS cluster o 12 uzloch (každý s procesorom Intel XEON), ktorý dokopy disponoval 1 TB RAM a 900 TB HDD.
...
{{ image(path="cypher.png" alt="Neo4j") }}
...
<p align="center">
    <img src="/metric.png" alt="Metrika v Kibane"/>
</p>
