...
{{ image(path="SparkEcosystem.png" alt="Spark Ecosystem") }}
...
{{ image(path="plan.png" alt="Príklad plánu") }}
...
```
Spustenie príkladov pribalených k inštalácii Sparku a celú dokumentáciu nájdete na [https://spark.apache.org/docs/latest/#running-the-examples-and-shell](https://spark.apache.org/docs/latest/#running-the-examples-and-shell)
