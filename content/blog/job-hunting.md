...
[extra]
comment = true
local_image = "sankey-sk.png"
+++

*Sumár môjho hľadania práce od posledného kvartálu 2025 a zistení o trhu a náborovom procese. Hľadala som primárne remote DevOps a QA (automation/SDET) pozície na Slovensku, v Česku, Poľsku a zahraničí (+ hybrid v Košiciach) a hlásila som sa do rôznych firiem od korporátov cez SW domy rôznej veľkosti po produktové firmy a startupy. Ide o anekdotickú skúsenosť, ale myslím, že každá správa "z frontu" sa hodí.*

# Východiskový bod, ciele a úspešný záver

V polovici októbra 2025 som sa ocitla po prvýkrát v IT nezamestnaná a hľadala som si prácu po sabatikale. Pri výpovedi som netušila, že budem mať dočinenia s trhom práce, ktorý v USA označujú ako [najhorší za dve dekády](https://www.businessinsider.com/tech-jobs-getting-demolished-great-recession-dot-com-era-2026-3) a zmeny neušetrili ani tunajší trh. Ubehli vyše 4 roky, čo som naposledy bola na pohovore a potrebovala som zistiť, kam sa požiadavky posunuli a získať nejaké pohovory na rozohriatie. Testovala som vody, či moje CV niekoho zaujme a zároveň som prechádzala DevOps bootcampom.
...
Prvý pohovor som mala v polovici novembra 2025, aktívnejšie som začala reagovať na inzeráty od januára a úmerne s neúspechom som zvyšovala obrátky, až sa job hunting stal činnosťou na plný úväzok. Koncom marca som dostala ponuku na senior QA, ktorú som prijala. Vzápätí prišla ponuka na mid DevOps, takže som splnila aj pôvodný cieľ.
...
gantt
    ...
    section DevOps bootcamp
    Prerekvizity : 2025-08-04, 2025-08-06
    Fundamentals : 2025-10-08, 2025-10-14
    Core : 2025-10-14, 2025-11-07
    Advanced : 2025-11-07, 2025-12-14
    Bootcamp na 90 % : milestone, v2, 2025-12-14, 2m

    section Hľadanie
    Hľadanie práce : done, 2025-10-15, 2026-03-26
    Reakcia vedúca k prvému pohovoru : vert, v7, 2025-10-20, 1d
    Zvýšená aktivita : crit, done, 2026-01-02, 2026-03-26
    Prvý pohovor : milestone, v6, 2025-11-18, 1d
    Začiatok hľadania QA pozícií : vert, 2026-02-11, 1d
    Prvá ponuka : milestone, v4, 2026-03-24, 1d
{% end %}

Hľadanie skončilo úspešne pred termínom, kvôli intenzite však bolo náročné - **za pár mesiacov som absolvovala viac pohovorov ako v celej doterajšej kariére**. Ich pozitívom bolo, že som mala možnosť zistiť viac o firmách a s niektorými si viem predstaviť spoluprácu v budúcnosti.

Demotivujúco pôsobilo, že inzeráty sú v prvých hodinách zavalené stovkami (na SK desiatkami) dokonale ušitých CV a motivačných listov, že [algoritmus LinkedInu znevýhodňuje profily s kariérnou prestávkou alebo iné "rizikové"](https://medium.com/@aubrey_87221/opentowork-recruiters-tell-you-not-to-look-desperate-linkedins-algorithm-requires-it-47b60da9b72c) a že recruiting sa sústredí na ľudí, ktorých chce odlákať od konkurenčných firiem (minimálne na SK). Do toho sa ešte človek dozvedá o [desaťtisícoch ajťákov prepustených vo svete](https://trueup.io/layoffs).
...
- **DevOps vs QA**: cielila som na DevOps pozície (na akej som ešte nepracovala) a neskôr aj QA (8+ ročná prax s automatizáciou). Pomer medzi nimi vyšiel presne 1:1 (20:20 žiadostí, 4:4 pohovorov a 1:1 ponúk + 1 nevyhranená ponuka). To som nečakala - DevOps pozícií na juniornom konci bolo ako šafranu, musela som skúšať hlavne mid a pri QA som očakávala pozitívny vplyv seniority. Vyzerá, že po DevOps je väčší dopyt, na mnohých miestach bolo viac otvorených DevOps pozícií ako QA.
...
- **seniorita a roly v QA**:
    ...
    - občas sa našla Quality Engineer rola ([QE, nie tradičná QA](https://medium.com/@Staragiletechbytes/quality-engineering-vs-quality-assurance-key-differences-76ad195b6d53)), videla som kombináciu QA/DevOps a zistila som, že u zahraničných firiem sa začala objavovať rola [Quality Platform Engineer](https://aiqualityengineer.cc/from-qa-teams-to-platform-capabilities-the-evolution-of-quality-engineering-in-platform-487e828afccf) na pomedzí vývoja, DevEx a kvality ako produktu a súčasti IDP (internej vývojovej platformy)
...
- **menej remote príležitostí**: mnoho firiem na SK a v ČR vyžaduje hybridný model práce, stretla som sa dokonca s on-site pozíciami. Full remote sa ešte nájdu, ale sú aj zahraničné firmy, ktoré umožňujú remote len v rámci vybraných krajín a SK medzi nimi často chýba.

- **fejky a stav IT globálne/lokálne** 
    - časť pozícií som nepokladala za reálne - či nedopatrením alebo úmyslom môžem len špekulovať (prišiel mi mail, že práve sme pozíciu obsadili a tá visí na stránke dodnes)
    - krvavý kúpeľ a zamrznutie trhu sú nerovnomerne distribuované a záleží na sektore a lokalite... niekedy je výhoda, že SK je pozadu za svetom 😅. Sú veľké firmy s pobočkami vo viacerých krajinách, ktoré majú otvorených presne 0 pozícií, iné zas stovky. Na LI málo vídam niekoho nastúpiť na nové miesto, naopak, rámčekmi OpenToWork sa to zelení a ľudia hľadajúci si prácu viac ako 2 roky nie sú raritou.
    - niektorí poukazujú na rôzne signály (nárast otvorených pozícií pre IT recruiterov) pre potenciál obratu k lepšiemu v globále. Lokálne som sama zvedavá, ktorým smerom sa trh pohne a či sa masové prepúšťania rozbehnú vo väčšom aj tu.

## Hľadanie

- **pracovné portály**: 
    - **Profesia** je nutné zlo a potrebovala by konkurenciu, najlepšie s anonymnými hodnoteniami firiem (táto služba na SK stále chýba)
    ...
    - **české a poľské portály** prispeli aspoň k prehľadu o finančnom ohodnotení na týchto trhoch - české platy sa mi zdali nižšie, čo je zreteľné, ak firma inzeruje pozíciu v oboch krajinách (ale sú aj opačné prípady). Pri slovenskej daňovej rezidencii sa teda veľmi neoplatí hľadať v ČR.
    ...
    - množstvo žiadostí spôsobuje, že niektoré firmy už po pár dňoch deaktivujú inzerát. Stalo sa mi, že som zaváhala, nechala som si úpravu CV k pozícii na zajtra a potom už bolo neskoro.
...
- **zdĺhavé procesy**: bežne sa mi ozvali 2-3 týždne po poslaní CV, keď už som to ani nečakala (dokonca aj po zrejme automatickom zamietavom emaili). S pohovormi sa firmy tiež neponáhľali a na jeden som čakala takmer 2 týždne. Najdlhšie konania od podania žiadosti mali vyše 2,5 a 1,5 mesiaca. Procesy mali často 3-4 kolá, výnimkou boli košické pobočky, kde stačilo 1 kolo.
...
- **GitHub**: spomenul ho jeden pán, že ma zachránil, keď ma ako testera chcel vyradiť, ale ako jedna z mála som mala GH a sľúbil mi pohovor (a poznamenal, že pani z HR by si GH nebola pozrela). Na technických kolách sa nikto ku GH nevyjadril.

Pozn.: pobavil inzerát českej firmy, v ktorom bolo, že nie sú ako rodina, len spolu pracujú (mali odo mňa malé bezvýznamné plus). Málokedy som narazila na skutočne podarený inzerát alebo v dobrom odlišný, ktorý zaujal.
...
Súčasný IT trh je nevyspytateľný a ani seniori to nemajú ľahké. Poctivou prípravou a s trochou šťastia je stále možné dosiahnuť úspech aj bez známostí. Dôležité je skúšať úpravy prístupu a nebrať si odmietnutia príliš k srdcu. 
...
1. **Nestratiť povedomie o trhu**, priebežne sledovať ponuku a **viackrát do roka zájsť na pohovor**, aby človek nevyšiel z cviku
